...
void auto_show_flags(FILE *fp) {
   ...
   fprintf (fp,"CC  = /opt/cray/pe/craype/2.6.2/bin/cc\n");
   fprintf (fp,"CXX = /opt/cray/pe/craype/2.6.2/bin/CC\n");
   fprintf (fp,"FC  = /opt/cray/pe/craype/2.6.2/bin/ftn\n");
   fprintf (fp,"F90 = /opt/cray/pe/craype/2.6.2/bin/ftn\n");
   fprintf (fp,"LD  = /opt/cray/pe/craype/2.6.2/bin/CC\n");
   fprintf (fp,"\n");
